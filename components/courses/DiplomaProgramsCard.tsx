  ...
  return (
    <div className="diploma-card">
      ...
      <div className="diploma-card__content">
        <p className="diploma-card__title">{title}</p>

        <p className="diploma-card__description">{description}</p>
        ...
        <div className="diploma-card__meta">
          ...
          <div className="diploma-card__classes">
            <ClipCoursesSvg height={13} width={13} />
        ...
        <a className="diploma-card__button" href="/contact">
          VER DIPLOMATURA
        </a>
      </div>
    </div>
