...
export const PageWelcome = ({
  ...
  return (
    <div
      className={`page-welcome__root-container ${
        orientationImage == "right" ? "sm:flex-row-reverse" : "sm:flex-row"
      }`}
    >
      ...
      <div className="page-welcome__text--wrapper">
        ...
        <div className="page-welcome__button-container">
          <Link
            className="w-full lg:w-44 page-welcome__button"
            href="/contacto"
          >
            {t("contact")}
          </Link>
          ...
          <Link
            className="w-full lg:w-44 page-welcome__button-secondary"
            href="/cursos"
          >
            {t("explore_courses")}
          </Link>
